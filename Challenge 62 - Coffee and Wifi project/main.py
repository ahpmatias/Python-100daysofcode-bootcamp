...
class CafeForm(FlaskForm):
    ...
    outlet_rating = SelectField('Power Outlet Rating', validators=[DataRequired()], choices=['🔌','🔌🔌','🔌🔌🔌','🔌🔌🔌🔌','🔌🔌🔌🔌🔌'])
...
@app.route('/cafes') 
def cafes():
    with open('Challenge 62 - Coffee and Wifi project\cafe-data.csv', newline='', encoding='utf-8') as csv_file:
